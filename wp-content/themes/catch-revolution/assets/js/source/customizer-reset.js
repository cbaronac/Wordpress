jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", catchRevolutionCustomizerReset.confirm, catchRevolutionCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: catchRevolutionCustomizerReset.nonce.reset,
                section: o[1]
            };
